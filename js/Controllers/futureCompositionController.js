bamApp.controller('futureCompositionController', ["$scope", "$rootScope", "$uibModal", "dataService", function ($scope, $rootScope, $uibModal, dataService) {

    this.dataService = dataService

    this.composition = {

        model: dataService.futureCompositionModel,

        getCurrentComposition: function() {
            return this.model.compositionCalcResults[dataService.vegetationModel.inFocusFutureVegetationZoneIndex]
        },
        ...
        addCompositionTransect: function () {
            if(this.model.compositionCalcResults[dataService.vegetationModel.inFocusFutureVegetationZoneIndex] == undefined) {
                this.addCompositionCalcResults();
            }
            this.model.compositionCalcResults[dataService.vegetationModel.inFocusFutureVegetationZoneIndex].compositionTransects.push(this.createCompositionTransect())
        }
    }
