bamApp.controller('futureStructureController', ["$scope", "$rootScope", "referenceDataService", "dataService", "$uibModal", function ($scope, $rootScope, referenceDataService, dataService, $uibModal) {

    this.dataService = dataService

    this.structure = {

        model: dataService.futureStructureModel,

        getCurrentStructure: function (index) {
            return this.model.structureCalcResults[dataService.vegetationModel.inFocusFutureVegetationZoneIndex]
        },
        ...
        getKeithClass: function () {
            return dataService.vegetationModel.input.pct[dataService.vegetationModel.inFocusFutureVegetationZoneIndex].keithClass.name
        },
        ...
        addStructureTransect: function () {
            if(this.model.structureCalcResults[dataService.vegetationModel.inFocusFutureVegetationZoneIndex] == undefined) {
                this.addStructureCalcResults()
            }
            this.model.structureCalcResults[dataService.vegetationModel.inFocusFutureVegetationZoneIndex].structureTransects.push(this.createStructureTransect())
        }
    }
}])