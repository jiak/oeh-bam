bamApp.controller('futureFunctionController', ["$scope", "$rootScope", "referenceDataService", "dataService", "$uibModal", function ($scope, $rootScope, referenceDataService, dataService, $uibModal) {

    this.dataService = dataService

    this.function = {

        model: dataService.futureFunctionModel,

        getCurrentFunction: function() {
            return this.model.functionCalcResults[dataService.vegetationModel.inFocusFutureVegetationZoneIndex]
        },
        ...
        addFunctionTransect: function () {
            if(this.model.functionCalcResults[dataService.vegetationModel.inFocusFutureVegetationZoneIndex] == undefined) {
                this.addFunctionCalcResults()
            }
            this.model.functionCalcResults[dataService.vegetationModel.inFocusFutureVegetationZoneIndex].functionTransects.push(this.createFunctionTransect())
        }
    }
