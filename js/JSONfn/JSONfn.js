...
(function (exports) {
    ...
    exports.parse = function (str, date2obj) {
        ...
        return JSON.parse(str, function (key, value) {
            var prefix;
            //BAM Uses 'function' as a type of assessment conflicts with simple function word test
            var secondFunctionTestOk = false;
            ...
            if (value.indexOf("(") >= 0) secondFunctionTestOk = true;

            if (iso8061 && value.match(iso8061)) {
                return new Date(value);
            }
            if (prefix === 'function' && secondFunctionTestOk) {
                return eval('(' + value + ')');
            }
            if (prefix === '_PxEgEr_') {
